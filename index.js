...
var handleTopbarSize = function (size) {
    switch (size) {
        case 'small':
            return '20px';
        case 'large':
...
var handleMidbarSize = function (size) {
    switch (size) {
        case 'small':
            return '15px';
        case 'large':
...
var handleBottombarSize = function (size) {
    switch (size) {
        case 'small':
            return '10px';
        case 'large':
...
var HamburgerButton = Ye.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  position: absolute;\n  display: ", ";\n  top: ", ";\n\n  right: ", ";\n\n  left: ", ";\n\n  padding: 20px;\n  max-width: 60px;\n  justify-content: center;\n  align-items: center;\n  cursor: pointer;\n  z-index: 9;\n  transition: all 0.5s ease-in-out;\n\n  & > .hamburger__button {\n    width: ", ";\n    height: 4px;\n    background: ", ";\n    border-radius: 5px;\n    transition: all 0.2s ease-in-out;\n\n    &::before,\n    &::after {\n      content: '';\n      position: absolute;\n      width: ", ";\n      height: 4px;\n      background: ", ";\n      border-radius: 5px;\n      transition: all 0.2s ease-in-out;\n    }\n\n    &::before {\n      transform: translateY(-10px);\n    }\n\n    &::after {\n      width: ", ";\n      transform: translateY(10px);\n    }\n  }\n\n  &.open .hamburger__button {\n    transform: translateX(-50px);\n    background: transparent;\n    box-shadow: none;\n\n    &::before {\n      transform: rotate(45deg) translate(35px, -35px);\n    }\n\n    &::after {\n      width: ", ";\n      transform: rotate(-45deg) translate(35px, 35px);\n    }\n  }\n\n  @media screen and (max-width: ", ") {\n    display: flex;\n  }\n\n  @media screen and (max-width: ", ") {\n    display: flex;\n  }\n"], ["\n  position: absolute;\n  display: ", ";\n  top: ",
    ";\n\n  right: ",
    ";\n\n  left: ",
    ";\n\n  padding: 20px;\n  max-width: 60px;\n  justify-content: center;\n  align-items: center;\n  cursor: pointer;\n  z-index: 9;\n  transition: all 0.5s ease-in-out;\n\n  & > .hamburger__button {\n    width: ", ";\n    height: 4px;\n    background: ", ";\n    border-radius: 5px;\n    transition: all 0.2s ease-in-out;\n\n    &::before,\n    &::after {\n      content: '';\n      position: absolute;\n      width: ", ";\n      height: 4px;\n      background: ", ";\n      border-radius: 5px;\n      transition: all 0.2s ease-in-out;\n    }\n\n    &::before {\n      transform: translateY(-10px);\n    }\n\n    &::after {\n      width: ", ";\n      transform: translateY(10px);\n    }\n  }\n\n  &.open .hamburger__button {\n    transform: translateX(-50px);\n    background: transparent;\n    box-shadow: none;\n\n    &::before {\n      transform: rotate(45deg) translate(35px, -35px);\n    }\n\n    &::after {\n      width: ", ";\n      transform: rotate(-45deg) translate(35px, 35px);\n    }\n  }\n\n  @media screen and (max-width: ",
    ") {\n    display: flex;\n  }\n\n  @media screen and (max-width: ",
    ") {\n    display: flex;\n  }\n"])), function (props) { return (props.theme.device !== 'all' ? 'none' : 'flex'); }, function (props) {
    return ['px', 'em', 'rem'].some(function (v) { return props.theme.top.includes(v); })
        ? props.theme.top
        : props.theme.top + 'px';
}, function (props) {
    return props.theme.direction === 'right'
        ? props.theme.right !== 'auto'
            ? ['px', 'em', 'rem'].some(function (v) { return props.theme.right.includes(v); })
                ? props.theme.right
                : props.theme.right !== '0'
    ...
    return props.theme.direction === 'left'
        ? props.theme.left !== 'auto'
            ? ['px', 'em', 'rem'].some(function (v) { return props.theme.left.includes(v); })
                ? props.theme.left
                : props.theme.left !== '0'
                    ? props.theme.left + 'px'
                    : 0
            : 'auto'
        : 'auto';
}, function (props) { return handleMidbarSize(props.theme.size); }, function (props) { return props.theme.color; }, function (props) { return handleTopbarSize(props.theme.size); }, function (props) { return props.theme.color; }, function (props) { return handleBottombarSize(props.theme.size); }, function (props) { return handleTopbarSize(props.theme.size); }, function (props) {
    return props.theme.device === 'mobile' && '420px';
}, function (props) {
...
var Hamburger = function (_a) {
    ...
    r$1.useEffect(function () {
        var _a, _b;
        if (isOpened) {
            (_a = buttonRef.current) === null || _a === void 0 ? void 0 : _a.classList.add('open');
        }
        else {
